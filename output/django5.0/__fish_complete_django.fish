...
function __fish_complete_django -d "Completions for django" --argument-names cmd
	...
	complete -c $cmd -n '__fish_use_subcommand' -a optimizemigration -d "Optimizes the operations for the named migration."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from check' -l database -d "Run database related checks against these aliases." -a "default"
	...
	complete -c $cmd -n '__fish_seen_subcommand_from check' -l list-tags -d "List available tags. Specify --deploy to include available deployment tags."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from check' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from compilemessages' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from createcachetable' -l database -d "Nominates a database onto which the cache tables will be installed. Defaults to the \"default\" database." -a "default"
	...
	complete -c $cmd -n '__fish_seen_subcommand_from createcachetable' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from dbshell' -l database -d "Nominates a database onto which to open a shell. Defaults to the \"default\" database." -a "default"
	...
	complete -c $cmd -n '__fish_seen_subcommand_from dbshell' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from diffsettings' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from dumpdata' -l database -d "Nominates a specific database to dump fixtures from. Defaults to the \"default\" database." -a "default"
	...
	complete -c $cmd -n '__fish_seen_subcommand_from dumpdata' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from flush' -l database -d "Nominates a database to flush. Defaults to the \"default\" database." -a "default"
	...
	complete -c $cmd -n '__fish_seen_subcommand_from flush' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from inspectdb' -l database -d "Nominates a database to introspect. Defaults to using the \"default\" database." -a "default"
	...
	complete -c $cmd -n '__fish_seen_subcommand_from inspectdb' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from loaddata' -l database -d "Nominates a specific database to load fixtures into. Defaults to the \"default\" database." -a "default"
	...
	complete -c $cmd -n '__fish_seen_subcommand_from loaddata' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from makemessages' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from makemigrations' -l check -d "Exit with a non-zero status if model changes are missing migrations and don't actually write them. Implies --dry-run."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from makemigrations' -l scriptable -d "Divert log output and input prompts to stderr, writing only paths of generated migration files to stdout."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from makemigrations' -l traceback -d "Display a full stack trace on CommandError exceptions."
	complete -c $cmd -n '__fish_seen_subcommand_from makemigrations' -l update -d "Merge model changes into the latest migration and optimize the resulting operations."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from migrate' -l check -d "Exits with a non-zero status if unapplied migrations exist and does not actually apply migrations."
	complete -c $cmd -n '__fish_seen_subcommand_from migrate' -l database -d "Nominates a database to synchronize. Defaults to the \"default\" database." -a "default"
	...
	complete -c $cmd -n '__fish_seen_subcommand_from migrate' -l prune -d "Delete nonexistent migrations from the django_migrations table."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from migrate' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from optimizemigration' -l check -d "Exit with a non-zero status if the migration can be optimized."
	complete -c $cmd -n '__fish_seen_subcommand_from optimizemigration' -l force-color -d "Force colorization of the command output."
	complete -c $cmd -n '__fish_seen_subcommand_from optimizemigration' -l no-color -d "Don't colorize the command output."
	complete -c $cmd -n '__fish_seen_subcommand_from optimizemigration' -l pythonpath -d "A directory to add to the Python path, e.g. \"/home/djangoprojects/myproject\"."
	complete -c $cmd -n '__fish_seen_subcommand_from optimizemigration' -l settings -d "The Python path to a settings module, e.g. \"myproject.settings.main\". If this isn't provided, the DJANGO_SETTINGS_MODULE environment variable will be used."
	complete -c $cmd -n '__fish_seen_subcommand_from optimizemigration' -l skip-checks -d "Skip system checks."
	complete -c $cmd -n '__fish_seen_subcommand_from optimizemigration' -l traceback -d "Display a full stack trace on CommandError exceptions."
	complete -c $cmd -n '__fish_seen_subcommand_from optimizemigration' -l version -d "Show program's version number and exit."
	complete -c $cmd -n '__fish_seen_subcommand_from optimizemigration' -s h -l help -d "show this help message and exit"
	complete -c $cmd -n '__fish_seen_subcommand_from optimizemigration' -s v -l verbosity -d "Verbosity level; 0=minimal output, 1=normal output, 2=verbose output, 3=very verbose output" -a "0 1 2 3"
	...
	complete -c $cmd -n '__fish_seen_subcommand_from runserver' -l skip-checks -d "Skip system checks."
	complete -c $cmd -n '__fish_seen_subcommand_from runserver' -l traceback -d "==SUPPRESS=="
	...
	complete -c $cmd -n '__fish_seen_subcommand_from runserver' -s v -l verbosity -d "==SUPPRESS==" -a "0 1 2 3"
	...
	complete -c $cmd -n '__fish_seen_subcommand_from sendtestemail' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from shell' -l no-imports -d "Disable automatic imports of models."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from shell' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from showmigrations' -l database -d "Nominates a database to show migrations for. Defaults to the \"default\" database." -a "default"
	...
	complete -c $cmd -n '__fish_seen_subcommand_from showmigrations' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from sqlflush' -l database -d "Nominates a database to print the SQL for. Defaults to the \"default\" database." -a "default"
	...
	complete -c $cmd -n '__fish_seen_subcommand_from sqlflush' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from sqlmigrate' -l database -d "Nominates a database to create SQL for. Defaults to the \"default\" database." -a "default"
	...
	complete -c $cmd -n '__fish_seen_subcommand_from sqlmigrate' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from sqlsequencereset' -l database -d "Nominates a database to print the SQL for. Defaults to the \"default\" database." -a "default"
	...
	complete -c $cmd -n '__fish_seen_subcommand_from sqlsequencereset' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from squashmigrations' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from startapp' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from startapp' -s x -l exclude -d "The directory name(s) to exclude, in addition to .git and __pycache__. Can be used multiple times."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from startproject' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from startproject' -s x -l exclude -d "The directory name(s) to exclude, in addition to .git and __pycache__. Can be used multiple times."
	complete -c $cmd -n '__fish_seen_subcommand_from test' -l debug-mode -d "Sets settings.DEBUG to True."
	complete -c $cmd -n '__fish_seen_subcommand_from test' -l durations -d "Show the N slowest test cases (N=0 for all)."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from test' -l failfast -d "Stops the test suite after the first failure."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from test' -l no-faulthandler -d "Disables the Python faulthandler module during tests."
	complete -c $cmd -n '__fish_seen_subcommand_from test' -l no-input -d "Tells Django to NOT prompt the user for input of any kind."
	complete -c $cmd -n '__fish_seen_subcommand_from test' -l parallel -d "Run tests using up to N parallel processes. Use the value \"auto\" to run one test process for each processor core."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from test' -l shuffle -d "Shuffles test case order."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from test' -l timing -d "Output timings, including database set up and total run time."
	complete -c $cmd -n '__fish_seen_subcommand_from test' -l traceback -d "Display a full stack trace on CommandError exceptions."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from test' -s r -l reverse -d "Reverses test case order."
	...
	complete -c $cmd -n '__fish_seen_subcommand_from testserver' -l traceback -d "Display a full stack trace on CommandError exceptions."
